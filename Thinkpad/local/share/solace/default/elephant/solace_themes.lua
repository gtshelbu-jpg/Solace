--
-- Dynamic Solace Theme Menu for Elephant/Walker
--
Name = "solacethemes"
NamePretty = "Solace Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/solace/themes"
  local solace_path = os.getenv("SOLACE_PATH") or ""
  local default_theme_dir = solace_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "solace-theme-set " .. theme_name,
            },
          })
        end
      end
