...
if solace-hw-dell-xps-haptic-touchpad; then
  ...
  sudo rm -f /etc/solace-dell-haptic-touchpad.env
  sudo systemctl daemon-reload
  sudo udevadm control --reload-rules

  source "$SOLACE_PATH/install/packaging/dell-xps-touchpad-haptics.sh"
fi
