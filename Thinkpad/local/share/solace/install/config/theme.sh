...
ln -snf ~/.config/solace/current/theme/btop.theme ~/.config/btop/themes/current.theme

mkdir -p ~/.config/mako
ln -snf ~/.config/solace/current/theme/mako.ini ~/.config/mako/config
